...
public class DecreeSender implements CommandSender {
     ...
     */
    public DecreeSender(CommandSender s, Plugin instance) {
        this(s, "", instance);
    }

    public DecreeSender(CommandSender s, String tag, Plugin instance) {
    ...
    public void sendMessageRaw(String message) {
        ...
        try {
            ...
            System.out.println("<NOMINI>Failure to parse " + a);
